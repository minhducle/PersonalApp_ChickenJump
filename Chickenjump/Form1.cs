    ...
    public partial class frmOwnProgram : Form
    {
        ...
        void picImage_Click(object sender, EventArgs e)
        {
            if (iBall )
            {
                ...
                iBall = !iBall;
                tmRun.Enabled = true;
                lblTxt.Text = "Click vào chú gà để vượt qua vật cản.";
            }
        }
        void btnHelp_Click(object sender, EventArgs e)
        {
            MessageBox.Show("Trò chơi vượt chướng ngại vật.\n"
               + "Người chơi kick vào chú gà để vượt qua những cây thông.\n"
               + "Điểm số sẽ được tính khi người chơi vượt qua 1 cây thông.\n"
        ...
        void tmStart_Tick(object sender, EventArgs e)
        {
            ...
            if (iScores <= 5)
            {
                picImagestone.Location = new Point(picImagestone.Location.X - 3, picImagestone.Location.Y);
                picImagestone2.Location = new Point(picImagestone2.Location.X - 3, picImagestone2.Location.Y);
            }
            else if (iScores > 5 && iScores <= 10)
            {
            ...
            else if (iScores > 10 && iScores <= 15)
            {
                picImagestone.Location = new Point(picImagestone.Location.X - 5, picImagestone.Location.Y);
                picImagestone2.Location = new Point(picImagestone2.Location.X - 5, picImagestone2.Location.Y);
            }
            else if (iScores > 15 && iScores <= 20)
            {
                picImagestone.Location = new Point(picImagestone.Location.X - 6, picImagestone.Location.Y);
                picImagestone2.Location = new Point(picImagestone2.Location.X - 6, picImagestone2.Location.Y);
            }
            else
            {
                picImagestone.Location = new Point(picImagestone.Location.X - 7, picImagestone.Location.Y);
                picImagestone2.Location = new Point(picImagestone2.Location.X - 7, picImagestone2.Location.Y);
            }
            if (iOver())
            {
                iBall = false;
